(defproject service-platform "0.1.0-SNAPSHOT"
              ...
              [{:id "app"
               ...
               {:id "test"
                ...
                :compiler {:output-to "dev-target/public/js/compiled/testable.js"
                           :main service-platform.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main service-platform.system
                           :output-to "resources/public/js/compiled/service_platform.js"
                           :output-dir "target"
                           :source-map-timestamp true
  ...
  :profiles {:dev
             ...
             {:source-paths ^:replace ["src/clj" "src/cljc"]
              :prep-tasks ["compile"
                           ["cljsbuild" "once" "min"]
                           ["run" "-m" "garden-watcher.main" "service-platform.styles"]]
              :hooks []
              :omit-source true
              :aot :all}})
