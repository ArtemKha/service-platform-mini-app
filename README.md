...
live reloading ClojureScript code and CSS, and the app server at port 8080 
...
Open `src/cljs/service-platform/core.cljs`, and change `dom/h1` to
...
select 'Browser'. Browse to [http://localhost:8080](http://localhost:8080)
...
"J", so `Meta-Shift-j`), point your browser at `http://localhost:8080`, and
you're good to go.
...
``` sh
lein uberjar
java -jar target/service-platform.jar
```

Now your app is running at
[http://localhost:8080/testapp](http://localhost:8080/testapp) in production mode.
